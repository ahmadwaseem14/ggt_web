"""
Django settings for ggt_web project.
...
SECRET_KEY = 'django-insecure-_ud9bc4%-kemdf2$=hdty-8*p$@zjiz-7ofr4hxm9^nqk0$j#b'
...
WSGI_APPLICATION = 'ggt_web.wsgi.application'
